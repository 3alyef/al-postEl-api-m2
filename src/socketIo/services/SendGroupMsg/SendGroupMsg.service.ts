...
class SendGroupMsg {
    public async initialize(socket: Socket, previousGroupMessages: Map<string, msgsGroupDB[]>, fromUser: string, deletedTo: "none" | "justFrom" | "all", toGroup: string, message: string, createdIn: string){
